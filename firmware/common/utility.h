...
//  round robbin foreach, start traversing from the last specified point. h is a static or global variable that retains the last position. The initial value of h is n !!
...
u64 mul32x32_64(u32 a, u32 b); // need irq disable

static inline u64 mul64_32x32(u32 u, u32 v)
{
#if 1 // tc32 speedup
    return mul32x32_64(u, v);
#elif 0
    u32  u0,   v0,   w0;
    u32  u1,   v1,   w1,   w2,   t;
    u32  x, y;
