...
/**
 * @brief       This function serves to check whether the public key is valid
 * @param[in]   curve	- ecc_curve_t
 * @param[in]   pub	- public key
 * @return      1: valid    0: invalid
 * @note        
 */
int blt_ecc_valid_pub_key(const unsigned char *pub, ecc_curve_t curve); // BLE_SRC_TELINK_MESH_EN
