...
/**
 * @brief       This function serves to check whether public key is valid
 * @param[in]   curve_sel	- ecc_curve select, p-256r1.
 * @param[in]   public_key	- public key, big--endian.
 * @return      0: invalid 1: valid
 * @note        only support p-256r1 in mesh sdk.
 */
int swECC_valid_public_key(const unsigned char *public_key, ecc_curve_t curve_sel); // BLE_SRC_TELINK_MESH_EN
