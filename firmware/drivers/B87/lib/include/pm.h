...
#define DEEP_ANA_REG0                       0x3a //initial value =0x00	[Bit1] The crystal oscillator failed to start normally.The customer cannot change!
												 ...
												 //                     [Bit4-7] already occupied by MESH_DEEP_ANA_REG
#define DEEP_ANA_REG1                       0x3b //initial value =0x00	[Bit0] system used, user can not use! // already occupied by SYS_DEEP_ANA_REG
...
/**
 * @brief       This function serves to reboot by reboot register REG_ADDR8(0x6f) = 0x20;
 * @return      
 * @note        
 */
void start_reboot_by_reg(void);// BLE_SRC_TELINK_MESH_EN
