 ...
 */
__attribute__((section(".cstartup_ram_funcs.analog_read"))) __attribute__((noinline)) unsigned char analog_read(unsigned char addr)
{
 ...
 * @return     none.
 */
__attribute__((section(".cstartup_ram_funcs.analog_write"))) __attribute__((noinline)) void analog_write(unsigned char addr, unsigned char v)
{
	unsigned char r = irq_disable();
