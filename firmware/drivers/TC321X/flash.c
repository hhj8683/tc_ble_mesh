 ...
 */
#if (PINGPONG_OTA_DISABLE) // BLE_SRC_TELINK_MESH_EN // because functions of "ota_fw_ow.c" need all to be in ramcode now.
_attribute_ram_code_
#endif
void flash_erase_sector(unsigned long addr)
{
#if (1) // BLE_SRC_TELINK_MESH_EN
    if(0 == is_valid_sector_addr(addr, 1)){
        return ;
    }
#endif
 ...
 */
#if (PINGPONG_OTA_DISABLE) // BLE_SRC_TELINK_MESH_EN
_attribute_ram_code_
#endif
