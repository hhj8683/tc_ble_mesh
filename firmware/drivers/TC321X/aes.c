...
#include "irq.h"        // BLE_SRC_TELINK_MESH_EN
#include "aes.h"
#include "bsp.h"
#include "clock.h"
#include "register.h"
...
#define AES_IRQ_PROTECTION_REQUIRED     (EXTENDED_ADV_ENABLE || BLE_REMOTE_SECURITY_ENABLE) // BLE_SRC_TELINK_MESH_EN
...
#if AES_IRQ_PROTECTION_REQUIRED // BLE_SRC_TELINK_MESH_EN
    unsigned char r = irq_disable(); //  because irq_mesh_sec_msg_check_cache() which is irq function will also call aes_encrypt(),48M aes_encrypt run 32us
#endif
