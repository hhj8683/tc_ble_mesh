...
#define GET_PWM_INVERT_VAL(gpio)     ((gpio==GPIO_PA1) || (gpio==GPIO_PA4) || (gpio==GPIO_PA6) || \
                                      (gpio==GPIO_PB0) || (gpio==GPIO_PB5) || (gpio==GPIO_PB7) || \
                                      (gpio==GPIO_PC1) || (gpio==GPIO_PC3) || (gpio==GPIO_PC5) || (gpio==GPIO_PC7) || \
                                      (gpio==GPIO_PD1) || (gpio==GPIO_PD3) || (gpio==GPIO_PD5) || (gpio==GPIO_PD7))
...
extern volatile unsigned char uart0_tx_done_flag;
