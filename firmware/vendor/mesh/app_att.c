...
#define MY_ATTRIBUTE_NMW \
	{MAX_NMW_ATT_NUM,ATT_PERMISSIONS_READ, 2,16,(u8*)(&my_primaryServiceUUID),	(u8*)(nmw_pri_service_uuid), 0},\
	{0,ATT_PERMISSIONS_READ, 2, 1,(u8*)(&my_characterUUID),		(u8*)(&nmw_ctl_prop), 0}, /*prop*/   \
	{0,ATT_PERMISSIONS_RDWR, 16,sizeof(nmw_ctl_data),(u8*)(nmw_ctl_uuid),	(nmw_ctl_data), &nmw_ctl_write, 0}, /*value*/   \
	{0,ATT_PERMISSIONS_RDWR, 2, sizeof(nmw_ctl_ccc),(u8*)(&clientCharacterCfgUUID),	(u8*)(nmw_ctl_ccc), 0}, /*value*/\
	{0,ATT_PERMISSIONS_READ, 2, 1,(u8*)(&my_characterUUID),		(u8*)(&nmw_ota_prop), 0}, /*prop*/   \
	{0,ATT_PERMISSIONS_RDWR, 16,sizeof(nmw_ota_data),(u8*)(nmw_ota_uuid),	(nmw_ota_data), &nmw_ota_write, 0} /*value*/
#endif
