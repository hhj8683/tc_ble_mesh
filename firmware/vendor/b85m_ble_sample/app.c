 ...
 * @return      none
 */
_attribute_ram_code_ void user_battery_power_check(u16 alarm_vol_mv, int loop_flag)
{
	...
	if(analog_read(USED_DEEP_ANA_REG) & LOW_BATT_FLG){
		battery_check_returnValue=app_battery_power_check(alarm_vol_mv+200, loop_flag);
	}
	else{
		battery_check_returnValue=app_battery_power_check(alarm_vol_mv, loop_flag);
	}
...
//////////////////////////// basic hardware Initialization  Begin //////////////////////////////////
	...
	/*The SDK must do a quick low battery detect during user initialization instead of waiting
	  ...
	  the chip will resume normal operation. Consider the following points in this design:
		...
		user_battery_power_check(VBAT_DEEP_THRES_MV, 0);
	#endif
...
_attribute_no_inline_ void main_loop(void)
{
	...
	///////////////////////////////////// Battery Check ////////////////////////////////
		...
		if(battery_get_detect_enable() && clock_time_exceed(lowBattDet_tick, 500000) ){
			...
			user_battery_power_check(VBAT_DEEP_THRES_MV, 1);
		}
	#endif
