...
#if 0 // (!MCU_SUPPORT_MULTI_PRIORITY_IRQ) // BLE_SRC_TELINK_MESH_EN
/**
...
void flash_protection_init(void)
{
	...
	switch(blc_flash_mid)
	{
        ...
        case MID1560C8:
            ...
            flash_unlock_mid          = (flash_unlock_t)flash_unlock_mid1560c8;
        ...
        case MID166085:
            ...
            flash_unlock_mid          = (flash_unlock_t)flash_unlock_mid166085;
        ...
        case MID186085:
            ...
            flash_unlock_mid          = (flash_unlock_t)flash_unlock_mid186085;
        ...
        case MID182085:
            flash_lock_mid            = (flash_lock_t)flash_lock_mid182085;
            flash_unlock_mid          = (flash_unlock_t)flash_unlock_mid182085;
...
#if 0 // Flash lock area is set in FLASH_LOCK_AREA_SUPPORT[]
/**
...
const flash_lock_area_support_t FLASH_LOCK_AREA_SUPPORT[] = { // area must be sorted from low to high if not zero.
	...
	{MID182085, {{FLASH_LOCK_LOW_256K_MID182085, (256/4)}, {FLASH_LOCK_LOW_512K_MID182085, (512/4)},
				{FLASH_LOCK_LOW_1M_MID182085, (1024/4)}, {FLASH_LOCK_ALL_16M_MID182085, (16*1024/4)}}},
	#endif
...
#else
u32 flash_unlock_with_check_current_st(u32 op_addr_begin) {return 0;}

void app_flash_protection_ota_end(u32 ota_err_code) {return;}

void flash_lock(unsigned int lock_addr_end, int ceiling_flag) {return;}
#endif
