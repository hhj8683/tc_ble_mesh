...
#define EVENT_MESH_PROV_COMPLETE            8
#define EVENT_MESH_PROV_FAILED              9

//#define EVENT_MESH_CFG_NETKEY_SET           0x0A
#define EVENT_MESH_CFG_APPKEY_SET           0x0B
#define EVENT_MESH_CFG_MODEL_BIND           0x0C
#define EVENT_MESH_CFG_SUB_SET              0x0D
//#define EVENT_MESH_CFG_PUB_SET              0x0E

#define EVENT_MESH_NODE_CONNECT             0x11
#define EVENT_MESH_NODE_DISCONNECT          0x12

#define EVENT_MESH_PROV_ATTENTION_TIMER_START         0x13
#define EVENT_MESH_PROV_ATTENTION_TIMER_STOP          0x14
...
void mesh_provision_para_reset(void);
...
u8 set_pro_record_list(pro_trans_record_list *p_rec_list , u16 prov_extension, 
											u16 *p_list,u32 cnt);
...
void set_pro_init_role(u8 role);
...
void mesh_proxy_master_terminate_cmd(void);
