...
#define LPN_PREPARE_NEXT_POLL_EN        0 // Prepare the next Friend Poll during the receive window, send friend poll in mesh_friend_poll_cache to save sending time.
